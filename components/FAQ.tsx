  ...
  return (
    <section className="w-full py-12 md:py-16">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">{title ?? messages.faq.title}</h2>
        <p className="text-slate-600">{subtitle ?? messages.faq.subtitle}</p>
      </div>
