...
import { getLocaleFromPath, removeLocaleFromPath, addLocaleToPath } from '@/lib/i18n/config'
...
export default function Navigation() {
  ...
  const isActive = (href: string) => {
    ...
    return (
      pathname === fullHref ||
      (href === '/guides' && cleanPath.startsWith('/guides')) ||
      (href === '/topics' && cleanPath.startsWith('/topics')) ||
