...
git add -u
git add "app/[slug]/" DEPLOYMENT.md components/FormatGrid.tsx components/Navigation.tsx lib/formats.ts push-and-deploy.bat
...
echo.
echo 3. 提交...
git commit -m "Use flat URLs: /mng-to-webp, /cur-to-jpg; remove old [source] routes" 2>nul
if errorlevel 1 (
    echo 无新提交或已提交，继续推送...
) else (
    echo 提交完成。
