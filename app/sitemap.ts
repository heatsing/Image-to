...
import { parseConverterSlug } from '@/lib/formats'
import { getGuideSlugs } from '@/lib/seo/guides'
import { getTopicSlugs } from '@/lib/seo/topics'
import { getConversionPriority, INDEXED_CONVERTER_SLUGS } from '@/lib/seo/url-quality'
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  INDEXED_CONVERTER_SLUGS.forEach((slug) => {
