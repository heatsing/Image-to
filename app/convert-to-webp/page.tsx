...
const pageTitle = 'Convert images to WebP online for free'
export const metadata: Metadata = {
  title: pageTitle,
  description:
    '100% free. Convert images to WebP locally—no uploads, no signup. Your files never leave your device. 40+ formats. Batch convert.',
  keywords: [
    'image to WebP',
    'convert to WebP',
    'WebP converter',
  ...
  openGraph: {
    ...
    description: '100% free. Convert images to WebP locally. No uploads, no signup. 40+ formats.',
  ...
  alternates: { canonical: `${baseUrl}/convert-to-webp` },
}
  ...
  return (
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl flex-1">
        ...
        <BenefitsSection title="Why Use Our WebP Converter?" subtitle="Smaller files, faster loading—convert to WebP locally and securely." />
        <FAQ />
      </main>
