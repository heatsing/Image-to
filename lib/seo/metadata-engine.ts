...
import { getFormatHubPath } from '@/lib/seo/page-content'
...
export function generateStructuredData(
  ...
  const formatHubPath = getFormatHubPath(source)
  const formatHubUrl = formatHubPath
    ? getCanonicalUrl(formatHubPath, locale)
    : getCanonicalUrl(`/convert-to-${target}`, locale)
  ...
  return faqSchema ? [webPage, softwareApp, breadcrumbs, faqSchema] : [webPage, softwareApp, breadcrumbs]
}
